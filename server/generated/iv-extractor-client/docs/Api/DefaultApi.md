...
```php
extractIv($image): \IvExtractorClient\Model\ExtractResponse
```
...
[**\IvExtractorClient\Model\ExtractResponse**](../Model/ExtractResponse.md)
...
```php
healthCheck(): \IvExtractorClient\Model\HealthResponse
```
...
[**\IvExtractorClient\Model\HealthResponse**](../Model/HealthResponse.md)
