...
namespace PokemonGoCalc\IvExtractorClient\Api;
...
use PokemonGoCalc\IvExtractorClient\FormDataProcessor;
use PokemonGoCalc\IvExtractorClient\HeaderSelector;
...
class DefaultApi
{
     ...
     *
     * @throws \PokemonGoCalc\IvExtractorClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \PokemonGoCalc\IvExtractorClient\Model\ExtractResponse|\PokemonGoCalc\IvExtractorClient\Model\ErrorResponse
     */
     ...
     * @throws \PokemonGoCalc\IvExtractorClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \PokemonGoCalc\IvExtractorClient\Model\ExtractResponse|\PokemonGoCalc\IvExtractorClient\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\PokemonGoCalc\IvExtractorClient\Model\ExtractResponse',
                        $request,
                        $response,
                    );
                case 400:
                    return $this->handleResponseWithDataType(
                        '\PokemonGoCalc\IvExtractorClient\Model\ErrorResponse',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\PokemonGoCalc\IvExtractorClient\Model\ExtractResponse';
        $request = $this->extractIvRequest($image, $contentType);
     ...
     * @throws \PokemonGoCalc\IvExtractorClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \PokemonGoCalc\IvExtractorClient\Model\HealthResponse
     */
     ...
     * @throws \PokemonGoCalc\IvExtractorClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \PokemonGoCalc\IvExtractorClient\Model\HealthResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function healthCheckWithHttpInfo(string $contentType = self::contentTypes['healthCheck'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\PokemonGoCalc\IvExtractorClient\Model\HealthResponse',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\PokemonGoCalc\IvExtractorClient\Model\HealthResponse';
        $request = $this->healthCheckRequest($contentType);
